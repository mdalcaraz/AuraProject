...
{
	return Spec.DynamicAbilityTags.HasTag(Slot);
}
...
void UAuraAbilitySystemComponent::ServerSpellSpendPoint_Implementation(const FGameplayTag& AbilityTag)
{
...
void UAuraAbilitySystemComponent::ServerEquipAbility_Implementation(const FGameplayTag& AbilityTag,	const FGameplayTag& Slot)
{
	if (FGameplayAbilitySpec* AbilitySpec = GetSpecFromAbilityTag(AbilityTag))
	{
		...
		if(bStatusValid)
		{
			...
			if (!SlotIsEmpty(Slot)) //There is an ability in this slots already. Deactivate an clear slot
			{
